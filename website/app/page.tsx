        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900">
              ...
              <span className="block text-blue-600">to CSV in Seconds</span>
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              The fastest way to export Instagram data for research, marketing, and lead generation.
              Get structured data from any public profile.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Why Choose IG Export?
            </h2>
            <p className="mt-4 text-lg text-gray-600">
              Everything you need to export and manage Instagram data
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 rounded-xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600">Export thousands of followers in seconds with our optimized engine</p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition-all">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Smart Data</h3>
              <p className="text-gray-600">Username, bio, website, follower count, verified status & more</p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600">Organize leads with tags, projects, and smart filtering</p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600">Export to CSV, JSON, XLSX - whatever works best for you</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Add IG Export to Chrome in one click</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Visit Profile</h3>
              <p className="text-gray-600">Go to any public Instagram profile</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Select data type and start export</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Download Data</h3>
              <p className="text-gray-600">Get your structured CSV/JSON file</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
            Ready to Export Instagram Data?
          </h2>
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
            Join thousands of marketers and researchers who use IG Export to grow their business
          </p>
          <a
            href="https://chrome.google.com/webstore/detail/YOUR_EXTENSION_ID"
            target="_blank"
